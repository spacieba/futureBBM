...
const updateHistoryCategories = () => {
  ...
  console.log(`📝 ${actionsWithoutCategory.length} catégories mises à jour dans l'historique`);
};
...
const initializeHistoricalData = () => {
  ...
  // 1. Initialiser les period_stats depuis l'historique existant
  ...
  periods.forEach(periodType => {
    ...
    // Récupérer toutes les actions de cette période
  ...
  // 2. Initialiser le Hall of Fame avec les scores actuels
